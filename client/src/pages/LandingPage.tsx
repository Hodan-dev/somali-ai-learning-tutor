...
export function LandingPage() {
  return (
    <div className="min-h-screen">
      <header className="sticky top-0 z-40 border-b border-blue-100 bg-white/90 backdrop-blur-md">
            ...
            <div className="relative space-y-5">
              ...
              <div className="space-y-3 text-sm text-blue-50">
                <div className="rounded-xl bg-white/10 p-3 backdrop-blur">
                  <div className="text-xs text-blue-100">Arday</div>
                  Maxaan u isticmaalaa force ee Physics?
                </div>
                <div className="rounded-xl bg-white/15 p-3 backdrop-blur">
                  <div className="text-xs text-sky-200">Macallinka AI</div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        <div className="rounded-[2rem] bg-gradient-to-r from-sea-dark to-sea px-6 py-10 text-white sm:px-10">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Link
              to="/register"
              className="rounded-xl bg-white px-5 py-3 text-sm font-semibold text-sea-dark hover:bg-blue-50"
            >
              Register as Student
            </Link>
            <Link
      ...
      <footer className="border-t border-blue-100 py-8 text-center text-sm text-muted">
